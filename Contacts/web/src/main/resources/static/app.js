...
window.onload = function () {
    ...
    phoneModal.bindAddFuncAndButton(addPhoneFunction);
    ...
    button.addEventListener("click", function() {
        phoneModal.edit(editPhoneFunction);
    });

    button = document.querySelector('#phone-delete');
    button.addEventListener("click", function() {
        phoneModal.delete(deleteFunction);
    });
    ...
    attachmentsModal.bindAddFuncAndButton(addAttachmentFunction);
    ...
    button.addEventListener("click", function() {
        attachmentsModal.edit(editAttachmentFunction);
    });

    button = document.querySelector('#attachment-delete');
    button.addEventListener("click", function() {
        attachmentsModal.delete(deleteFunction);
    });
...
function editPhoneFunction(selectedRow) {
    
}

function editAttachmentFunction(selectedRow) {
    
}

function deleteFunction(selectedRow) {
